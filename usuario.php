								...
								<div class="formulario">
									...
									<font size= 4>
										<tr>
											...
											<td>
												<input class="required" type="name" name="nombre" onkeypress="return soloLetras(event)" id="nombre" maxlength="30" size= "35" style='font-size: 16px'/><b style="color:red;">*</b>
										...
										<tr>
											...
											<td>
												<input type="name" name="apellido"  onkeypress="return soloLetras(event)"  id="apellido" maxlength="30" size= "35" style='font-size: 16px'/><b style="color:red;">*</b>
											</td>
										</tr>
										<tr>
											<td style='font-size: 16px'>
											...
											<td>
												<input type="name" name="nice"maxlength="20" onkeypress="return validacion_usuarios(event)"size= "20" style='font-size: 16px' /><b style="color:red;">*</b>
											</td>
										</tr>
										<tr>
											<td style='font-size: 16px'>
											...
											<td>
												<input type="name" class="easyui-validatebox" data-options="required:true,validType:'email'" name="correo" maxlength="30"onkeypress="return valida_email(event)" size= "35" style='font-size: 16px' /><b style="color:red;">*</b>
											</td>
										</tr>
										<tr> 
											<td style='font-size: 16px'>
											...
											<td>
												<input type="password" name="password" maxlength="20" onkeypress="return validacion_usuarios(event)"size= "20" style='font-size: 16px'/><b style="color:red;">*</b>
