...
class Login {
    ...
    public $campo_usuario='nice'; //campo que contiene los datos de los usuarios (se puede usar el email)
   ...
   public function __destruct() {
    ...
    public function login($usuario, $password) {
        ...
        $query='SELECT '.$this->campo_usuario.', '.$this->campo_clave.', id_estado FROM '.$this->tabla.' WHERE '.$this->campo_usuario.'="'.  mysql_real_escape_string($usuario).'" LIMIT 1 '; //la tabla y el campo se definen en los parametros globales
